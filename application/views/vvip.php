...
<!-- Home -->
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(<?=base_url().'assets/frontend/images/categories.jpg'?>)"></div>
			<div class="home_content_container">
				<div class="container">
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Very Very Important Person (VVIP)<span>.</span></div>
			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_image">
						<div class="details_image_large"><img src="<?=base_url().'assets/frontend/images/details_1.jpg'?>" alt=""><div class="product_extra product_new"><a href="categories.html">New</a></div></div>
					</div>
				</div>
				...
				<div class="col-lg-6">
					<div class="details_content">
						<div class="details_name">VVIP Ticket</div>
						<div class="details_price">Rp 4.000.000</div>
